        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <div style={{ display: "flex", gap: "12px", marginTop: "12px" }}>
              ...
              <a href="https://github.com/mrnetwork0001/FluenciAI" target="_blank" rel="noopener noreferrer" style={{ color: "#888", transition: "color 0.2s" }} onMouseOver={e => e.currentTarget.style.color = "#fff"} onMouseOut={e => e.currentTarget.style.color = "#888"} aria-label="GitHub">
